				...
				<div class="x_content">
					<div class="col-md-3 col-sm-3 col-xs-12 profile_left">
						<div class="profile_img">
							<div id="crop-avatar">
								<img class="img-responsive avatar-view"
									src="/static/images/picture.png" alt="Avatar"
						...
						<ul class="list-unstyled user_data">
							<li><i class="fa fa-map-marker user-profile-icon"></i> 경기도
								파주시 와동동</li>
							...
							<li class="m-top-xs"><i
								...
								href="https://github.com/ldk-hub" target="_blank">https://github.com/ldk-hub</a>
							</li>
						</ul>
						<button type="button" class="btn btn-dark" data-toggle="modal"
							data-target="#updateUsermodal">회원 정보등록</button>
						<br />
					</div>
						...
						<div class="" role="tabpanel" data-example-id="togglable-tabs">
							<ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
								<li role="presentation" class="active"><a
									...
									aria-expanded="true">프로젝트</a></li>
								<li role="presentation" class=""><a href="#tab_content2"
									role="tab" id="profile-tab" data-toggle="tab"
									aria-expanded="false">방명록</a></li>
								<li role="presentation" class=""><a href="#tab_content3"
									role="tab" id="profile-tab2" data-toggle="tab"
									aria-expanded="false">업무역량</a></li>
							</ul>
							<div id="myTabContent" class="tab-content">
								...
								<div role="tabpanel" class="tab-pane fade" id="tab_content2"
									...
									<ul class="messages">
										<li><img src="/static/images/user.png" class="avatar"
											alt="Avatar">
