...
<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
    <div class="menu_section">
        ...
        <ul class="nav side-menu">
            <li><a><i class="fa fa-edit"></i> 개발예정 목록 <span class="fa fa-chevron-down"></span><span class="label label-success pull-right">공사중</span></a>
                <ul class="nav child_menu">
                    <li><a href="form">사이트 샘플 폼</a></li>
                    <li><a href="form_wizards">폼설계 페이지</a></li>
                    <li><a href="page_403.html">403 Error</a></li>
                    <li><a href="page_404.html">404 Error</a></li>
                    <li><a href="page_500.html">500 Error</a></li>
                    <li><a href="calendar">일정표</a></li>
                </ul>
            </li>
            ...
            <li><a><i class="fa fa-desktop"></i> 개발 샘플API<span class="fa fa-chevron-down"></span><span class="label label-success pull-right">공사중</span></a>
                <ul class="nav child_menu">
